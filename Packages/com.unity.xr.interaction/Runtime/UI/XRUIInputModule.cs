...
namespace UnityEngine.XR.Interaction.UI
{
    public class XRUIInputModule : UIInputModule
    {
        ...
        {
            public RegisteredPointer(XRPointer pointer, int deviceIndex)
            {
        ...
        public void RegisterPointer(XRPointer pointer)
        {
            EnsureInitialized();
        ...
        public void UnregisterPointer(XRPointer pointer)
        {
            EnsureInitialized();
        ...
        public bool GetTrackedDeviceModel(XRPointer pointer, out TrackedDeviceModel model)
        {
            EnsureInitialized();
