...
namespace UnityEngine.XR.Interaction
{
    ...
    public abstract class XRBaseInteractable : MonoBehaviour
    {
        ...
        /// <summary>Event that gets called when this interactable is deactivated.</summary>
        public event Action<XRBaseInteractor> deactivated;
        ...
        protected internal virtual void OnDeactivate(XRBaseInteractor interactior)
        {
            if (deactivated != null)
                deactivated(interactior);
        }
    }
}