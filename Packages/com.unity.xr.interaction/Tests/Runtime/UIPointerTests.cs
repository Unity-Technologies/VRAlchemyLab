...
namespace UnityEngine.XR.Interaction.Tests
{
    ...
    internal class UIPointerTests
    {
        ...
        internal static TestObjects SetupUIScene()
        {
            ...
            GameObject pointerGo = new GameObject("Pointer", typeof(XRPointer), typeof(XRController), typeof(XRControllerRecorder));
            ...
            XRPointer pointer = pointerGo.GetComponent<XRPointer>();
