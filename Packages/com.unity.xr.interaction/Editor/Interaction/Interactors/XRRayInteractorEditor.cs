...
namespace UnityEditor.XR.Interaction
{
    ...
    internal class XRRayInteractorEditor : Editor
    {
        ...
        static class Tooltips
        {
            ...
            public static readonly GUIContent sphereCastRadius = new GUIContent("Sphere Cast Radius", "Radius of this Interactor's ray, used for spherecasting. A Sphere Cast Radius of 0 or less means regular raycasting is used.");
