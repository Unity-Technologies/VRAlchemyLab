...
namespace UnityEditor.XR.Interaction
{
    ...
    internal class XRControllerEditor : Editor
    {
        ...
        static class Tooltips
        {
            public static readonly GUIContent preset = new GUIContent(
                "Preset",
                "ControllerPreset asset to override this Controller's input bindings and model.");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_Preset, Tooltips.preset);

            if (!m_Preset.objectReferenceValue)
            {
