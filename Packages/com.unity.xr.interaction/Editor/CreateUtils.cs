...
namespace UnityEditor.XR.Interaction
{
    internal static class CreateUtils
    {
        ...
        static void CreateRayInteractor()
        {
            ...
            var rayInteractableGo = ObjectFactory.CreateGameObject("Ray Interactor",
                typeof(XRController),
        ...
        static XRRig CreateXRRig()
        {
            ...
            var xrRigGO = ObjectFactory.CreateGameObject("XR Rig",
                typeof(XRRig));
            ...
            if (xrCamera == null)
            {
                var xrCameraGO = ObjectFactory.CreateGameObject("Camera", typeof(Camera));
        ...
        static XRRig CreateXRRigWithHandControllers()
        {
            ...
            if (xrCamera == null)
            {
                var xrCameraGO = ObjectFactory.CreateGameObject("XR Camera", typeof(Camera));
                xrCamera = xrCameraGO.GetComponent<Camera>();
            }
            ...
            var leftHandRayInteractorGO = ObjectFactory.CreateGameObject("LeftHand Controller",
                typeof(XRController),
                typeof(XRRayInteractor),
                typeof(LineRenderer),
                typeof(XRInteractorLineVisual));

            SetupLineRenderer(leftHandRayInteractorGO.GetComponent<LineRenderer>());
            ...
            var rightHandRayInteractorGO = ObjectFactory.CreateGameObject("RightHand Controller",
                typeof(XRController),
                typeof(XRRayInteractor),
                typeof(LineRenderer),
                typeof(XRInteractorLineVisual));
            ...
            SetupLineRenderer(rightHandRayInteractorGO.GetComponent<LineRenderer>());
        ...
        static void CreateLocomotionSystem()
        {
            ...
            snapTurnProvider.PrimaryDeviceRole = InputDeviceRole.LeftHanded;
            snapTurnProvider.enableSecondaryDevice = true;
            snapTurnProvider.SecondaryDeviceRole = InputDeviceRole.RightHanded;
        }
        ...
        static void CreateTeleportationArea()
        {
            ...
            plane.AddComponent<XRInteractableEventCallbacks>();
        ...
        static void CreateXRUIPointer()
        {
            ...
            if(selectedGo == null)
            {
                selectedGo = new GameObject("Controller", typeof(XRController), typeof(XRPointer));
            }
           
            XRController controller = selectedGo.GetComponent<XRController>();
            if(controller == null)
            {
                GameObject controllerGo = new GameObject("Controller", typeof(XRController), typeof(XRPointer));
            ...
            XRPointer pointer = selectedGo.GetComponent<XRPointer>();
            if (pointer == null)
                selectedGo.AddComponent<XRPointer>();
